      ...
      <main className="flex min-h-screen items-center justify-center bg-slate-50 p-6">
        <Card>
          <div className="w-full max-w-md space-y-5">
            <div>
              <h1 className="text-2xl font-bold">Satış & Ortaklık Paneli</h1>
              <p className="text-sm text-slate-500">Güvenli giriş prototipi</p>
            </div>
            <input className="input" placeholder="E-posta / kullanıcı adı" defaultValue="admin@example.com" />
            <input className="input" placeholder="Şifre" type="password" defaultValue="123456" />
            <button className="btn w-full" onClick={() => setLoggedIn(true)}>Giriş Yap</button>
          </div>
        </Card>
      </main>
    );
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-slate-50 p-6">
        <Card>
          <div className="w-full max-w-md space-y-5">
            <div>
              <h1 className="text-2xl font-bold">2FA Doğrulama</h1>
              <p className="text-sm text-slate-500">Authenticator kodunu girin</p>
            </div>
            <input className="input" placeholder="6 haneli kod" defaultValue="123456" />
            <button className="btn w-full" onClick={() => setMfaOk(true)}>Doğrula</button>
          </div>
        </Card>
      </main>
    );
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section className="p-5 lg:ml-72 lg:p-8">
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          ...
          <button className="btn-secondary" onClick={() => { setLoggedIn(false); setMfaOk(false); }}>Çıkış</button>
        </div>
